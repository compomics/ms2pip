...
def ms2pip_init(amino_masses_fname, modifications_fname, modifications_fname_sptm):
    """Initialize MS2PIP C code with given masses for amino acids and modifications"."""
...
def get_vector(
    ...
    """Get feature vector for given peptide and charge."""
...
def get_predictions(
    ...
    """Get intensity predictions from C-model."""
...
def get_targets(*args):
    ...
    if args[4] == 'general':
        ...
        raise NotImplementedError(args[4])
    return result
...
def get_targets_all(
    ...
    """Get target intensities for all supported ion types."""
...
def get_targets_general(
    ...
    """Get target intensities for singly-charged b- and y-ions."""
...
def get_targets_etd(
    ...
    """Get target intensities for ETD fragment ions."""
...
def get_targets_ch2(
    ...
    """Get target intensities for singly- and doubly-charged b- and y-ions."""
...
def get_mzs_general(
    ...
    """Get theoretical m/z values for singly-charged b- and y-ions."""
...
def get_mzs_etd(
    ...
    """Get theoretical m/z values for ETD fragment ions."""
...
def get_mzs_ch2(
    ...
    """Get theoretical m/z values for singly- and doubly-charged b- and y-ions."""
